...
const Header = () => {
  ...
  const handleSearchQuery = (e) => {
    if ((e.key === "Enter" || e === "searchButton") && searchQuery) {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row pt-6 pb-6 items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-[#0f0f0f]">
            {loading && <Loader />}
